...
df = pd.DataFrame(main_battle_tanks).to_csv(f'data_csv/main_battle_tanks_{no}.csv', index=False).to_excel(f'data_excel/main_battle_tanks_{no}.xlsx', index=False).to_json(f'data_json/main_battle_tanks_{no}.json', orient='records')
